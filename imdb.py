...
def get_m_content(start):
    url = "https://www.imdb.com/search/title?title_type=feature&year=2018-01-01,2018-12-31&start={}&ref_=adv_nxt".format(start)
    print(url)
